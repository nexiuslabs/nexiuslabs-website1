...
export function PlaybookLanding() {
  ...
  return (
    <div className="min-h-screen bg-nexius-dark-bg pt-24 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {!unlocked ? (
          ...
          <div className="space-y-4">
            <div className="bg-nexius-dark-surface border border-nexius-dark-border rounded-xl px-4 py-3 flex items-center justify-between gap-3">
              <div>
            ...
            <div className="rounded-xl overflow-hidden border border-nexius-dark-border bg-white">
              <iframe
